...
The current forlder contains the following subdirectories:
   1- "Santos_and_Duarte" which contains the codes and the data experimented in [1] using the dataset proposed in [3].
   2- "Oliveira + Santos_and_Duarte" which contains the codes and the data experimented in [1] using the datasets proposed in [3] and [4].
   3- "ExampleArticle" which contains the codes and the data used in the practical example presented in [1].
________________________________________________________________________________________________   
...
[3] Oliveira, C.E.N., Souza, C., Treza, R.d.C., Hondo, S.M., Los Angeles, E., Bernardo, C., Shida, T.K.F., Oliveira, L., Novaes, T.M., Campos, D.d.S.F., et al.
